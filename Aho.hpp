...
public:
    ...
    struct Vertex {
        ...
        bool is_leaf = false;      // Flag that some word from the dictionary ends in this vertex
    };
    ...
    void add_string(const std::string& s)
    {
        ...
        trie[curVertex].is_leaf = true;
        trie[curVertex].word_ID = wordID;
        leaves.push_back(curVertex);
    ...
    int get_suffix_link(int curVertex)
    {
        return trie[curVertex].suffix_link;
    }
    std::vector<int> get_children(int curVertex)
    {
...
private:
    ...
    void CalcSuffLink(int vertex)
    {
        ...
        { 
            ...
            if (trie[vertex].is_leaf) trie[vertex].end_word_link = vertex;
